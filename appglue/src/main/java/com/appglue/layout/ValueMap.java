...
public class ValueMap extends LinearLayout implements Comparator<ServiceIO> {
    ...
    public ValueMap(Context context) {
        super(context);

        create(context);
    }

    public ValueMap(Context context, AttributeSet attributes) {
        super(context, attributes);
        create(context);
    }

    public ValueMap(Context context, AttributeSet attributes, int defStyle) {
    ...
    public void create(Context context) {
        ...
        this.addView(View.inflate(context, R.layout.value_map, null));
...
//		Collections.sort(ios, ValueMap.this);
//
...
//						setHighlight(item.getType(), parent);
            ...
            endpoint.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    // Show the dialog
//					DialogConnection cd = new DialogConnection(activity, ValueMap.this, outputList, inputList, item, position);
//					cd.show();
                    return true;
                }
            });
