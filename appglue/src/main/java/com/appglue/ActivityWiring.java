...
public class ActivityWiring extends ActionBarActivity implements ViewPager.OnPageChangeListener {
    ...
    private FragmentWiring wiringFragment;
    private FragmentComponentList componentListFragment;
...
//    private MenuItem modeMenuItem;
	...
	public void onCreate(Bundle icicle)
	{
        ...
        wiringFragment = (FragmentWiring) fm.findFragmentById(R.id.wiring_fragment);
...
//                } else {
//                    cs.addComponent(component, cs.size());
//                }
//
//                registry.updateCurrent();
//            }
